...
import { Eye, EyeOff, Moon, Sun, UserPlus, Mail, Lock, ArrowRight, AlertCircle } from 'lucide-react';
        ...
        >
          <motion.div variants={formItemVariants} className="flex justify-center mb-8">
            <div className={`p-3 rounded-full ${darkMode ? 'bg-[#3D3D3D]' : 'bg-gray-100'}`}>
              <UserPlus className={`h-8 w-8 ${currentTheme.heading}`} />
            </div>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.div variants={formItemVariants}>
              <label htmlFor="confirmPassword" className={`block text-sm font-medium ${currentTheme.textSecondary} mb-1`}>
                Confirm Password
              </label>
              <div className="relative">
                <input
            ...
            <motion.div variants={formItemVariants}>
              <button
                ...
                className={`w-full ${currentTheme.button} font-medium py-2.5 px-4 rounded-md
                  focus:outline-none transition duration-200 disabled:opacity-50 mt-4 
          ...
          >
            <span className={currentTheme.textSecondary}>Already have an account? </span>
            <Link 
              href="/signin" 
